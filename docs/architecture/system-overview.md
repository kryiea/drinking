...
- 当前 seed 目录优先覆盖中国高频品牌 starter pack：`瑞幸`、`星巴克`、`库迪`、`喜茶`、`霸王茶姬`、`一点点`，并保留少量咖啡样例用于冲煮与计算演示。
...
- 记录页当前以品牌小 logo rail + 极简 row 为主结构，避免让品牌名和冗长说明抢占首屏。
- 视觉系统默认跟随浅色 / 深色模式，关键阈值线、状态数值和快速记录入口必须在两套外观下保持清晰。
