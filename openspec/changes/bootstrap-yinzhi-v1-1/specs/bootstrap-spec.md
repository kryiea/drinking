...
- The recommendation response must include rule id, inputs, threshold comparison, action, and risk message.
- The repository must contain AI-facing documentation at the root and in `docs/`.
