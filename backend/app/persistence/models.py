...
class DrinkDefinitionRow(Base):
    ...
    brand_collection: Mapped[Optional[str]] = mapped_column(String(120), nullable=True)
    tags: Mapped[List[str]] = mapped_column(JSON, default=list)
    hero_flavor: Mapped[Optional[str]] = mapped_column(String(120), nullable=True)
    preparation_methods: Mapped[List[str]] = mapped_column(JSON, default=list)
    brew_recipe: Mapped[Optional[dict[str, Any]]] = mapped_column(JSON, nullable=True)
...
class DrinkLogRow(Base):
    ...
    preparation_method: Mapped[Optional[str]] = mapped_column(String(40), nullable=True)
